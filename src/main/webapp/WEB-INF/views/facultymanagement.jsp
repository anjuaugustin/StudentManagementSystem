...
.facultydisplaytable tr:nth-child(odd){ background-color:#d4ffaa; }
.facultydisplaytable tr:nth-child(even)    { background-color:#ffffff; }.facultydisplaytable td{
...
.facultyaddtable tr:nth-child(odd){ background-color:#d4ffaa; }
.facultyaddtable tr:nth-child(even)    { background-color:#ffffff; }.facultyaddtable td{
	vertical-align:middle;
...
<body>
	...
	<form method="post" action="addFaculty">
		...
		<table>
		<tr><td colspan="2">Enter the Details of the Student</td></tr>
			<tr>
				<td>Username</td>
