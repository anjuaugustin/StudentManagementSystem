...
<link href="<c:url value="/resources/admin/css/icheck/flat/green.css"/>"
	rel="stylesheet" />
<link href="<c:url value="/resources/admin/css/floatexamples.css"/>"
									...
									<tbody>
										<c:forEach var="person" items="${persons}">
											<tr class="even pointer">
												...
												<td class=" ">${person.username}</td>
												
												<td class=" ">${person.studentID}</td>
												<td class=" ">${person.fathersName}</td>
												<td class="a-right a-right ">${person.fathersJob}</td>
												
												<td class=" ">${person.classroom}</td>
												<td class=" ">${person.rollNo}</td>
												<td class=" ">${person.gender}</td>
												<td class=" ">${person.email}</td>
												<td class=" ">${person.permanentAddress}</td>
												<td class=" ">${person.dateOfBirth}</td>
												<td class=" ">${person.mobileNumber}</td>												
...
<!-- Datatables -->
        <script src="<c:url value="/resources/admin/js/datatables/js/jquery.dataTables.js"/>"></script>
        <script src="<c:url value="/resources/admin/js/datatables/tools/js/dataTables.tableTools.js"/>"></script>
        <script>
